...
class ModelTraining:
    ...
    def train_lgbm(self, X_train, y_train):
        try:
            logger.info("Initializeing the model")
            lgbm_model = lbgm.LGBMClassifier(random_state=self.random_search_params['random_state'])
    ...
    def run(self):
        try:
            with mlflow.start_run():
                ...
                # store in artifact(dataset folder) section in mlflow ui
